...
export default function ProfessorProfile() {
    ...
    const [email, setEmail] = useState('annics@rpi.edu')
    const [phoneNum, setPhoneNum] = useState("999-999-9999");
    const [office, setOffice] = useState('SA 4206');
    const [rpiPage, setRpiPage] = useState('');
    const [image, setImage] = useState('../assets/images/Anicca_square.png');
    const [dept, setDept] = useState('Communication & Media')
            ...
            <ScrollView>
                <View style={styles.profileHeader}>
                    ...
                    <View style={{flex: 1, flexDirection: 'column'}}>
                        ...
                        <Text style={{marginLeft: 30}}>{dept}</Text>
                    </View>
                </View>
                {/*contact card*/}
                <View style={styles.contactCard}>
                    <ContactInfoRow icon="mail" text={email} />
                    <ContactInfoRow icon="phone" text={phoneNum} />
                    <ContactInfoRow icon="map-pin" text={office} />
                    <ContactInfoRow icon="link" text={rpiPage} />
                </View>
